...
Hãy phân tích các vấn đề về privacy, GDPR, data protection, data breach và hậu quả pháp lý nếu có."""
...
async def main():
    ...
    with open("stage4_graph.png", "wb") as f:
        f.write(graph.get_graph().draw_mermaid_png())
    print("Graph image saved to stage4_graph.png")
